// Same as mlir_tensor_parallel.mlir but intentionally *without* the final
// stablehlo.all_reduce. This file is meant to be an input for the small
// collective-insertion tool (stablehlo_tp_allreduce_pass.py).
